    ...
    <>
      ...
      <nav>
        <a href="/" className="logo">
          <div className="logo-dot"></div>iLoveAnki
        </a>
      </nav>

      <section className="hero" style={{ minHeight: 'calc(100vh - 80px)', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '2rem 1rem' }}>
        <div className="deck-card" style={{ maxWidth: '420px', width: '100%', margin: '0' }}>
          <div className="fade-in">
            ...
            <button
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[rgba(255,255,255,0.1)] bg-[#131820] text-[#eef6ff] font-medium hover:bg-[rgba(255,255,255,0.05)] transition-all mb-6"
