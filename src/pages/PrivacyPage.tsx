...
import { ArrowLeft, Shield, Lock, Eye, Database, Twitter, Github, Linkedin } from 'lucide-react';
      ...
      <footer className="max-w-7xl mx-auto px-6 py-12 border-t border-white/5">
        <div className="flex flex-col items-center">
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a href="/terms" className="text-[11px] uppercase tracking-wider text-[#8899aa] hover:text-sky-400 transition-colors">Terms of Service</a>
            <a href="/privacy" className="text-[11px] uppercase tracking-wider text-sky-400 font-bold">Privacy Policy</a>
