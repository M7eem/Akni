...
import { Clock, Layers, FileText, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {decks.map((deck) => (
          <div key={deck.id} className="bg-[#131820] p-5 rounded-xl border border-[rgba(255,255,255,0.05)] hover:border-[rgba(125,211,252,0.3)] transition-colors">
